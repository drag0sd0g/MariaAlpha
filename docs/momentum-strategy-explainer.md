...
- [`vwap-strategy-explainer.md`](vwap-strategy-explainer.md) and [`twap-strategy-explainer.md`](twap-strategy-explainer.md) — the sibling *execution* strategies this one complements.
