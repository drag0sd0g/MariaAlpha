...
> **Note:** This document is a frozen snapshot of the codebase at the moment of the 1.10.3 merge. References to a "14-service stack", the *Phase 2 entry points*, and any "Phase 2 will…" language reflect the state at that point. Since then, **2.1.1 (Smart Order Router)**, **2.1.3 / 2.1.4 (IOC / FOK / GTC / Iceberg)**, and **2.7.1 (Helm chart for Kubernetes)** have shipped — see the [§11 Iteration Roadmap in the TDD](technical-design-document.md#11-iteration-roadmap) for the current status of every Phase 2 issue. Do not edit this file to track ongoing work; treat it as historical.
