 ...
 *       shares; the unallocated remainder is awarded to the highest-weighted sub-account so the
 *       sum of allocations equals the parent fill exactly. This is the industry-standard default.
